# 📚 EMSI Flow - Authentification (Données Réelles)

Ce document contient les identifiants de test à jour, synchronisés avec la base de données réelle.
...
| :------------- | :----------------- | :-------------- |
| **Admin EMSI** | `admin@emsi.ma`    | `Admin@2026`    |
| **Directeur**  | `director@emsi.ma` | `Director@2026` |
...
| Nom              | Email                 | Mot de passe       |
| :--------------- | :-------------------- | :----------------- |
| **Coordinateur** | `coordinator@emsi.ma` | `Coordinator@2026` |
| **Professeur 1** | `teacher1@emsi.ma`    | `Teacher@2026`     |
| **Professeur 2** | `teacher2@emsi.ma`    | `Teacher@2026`     |
| **Professeur 3** | `teacher3@emsi.ma`    | `Teacher@2026`     |

---

## 👨‍🎓 Étudiants (Profils Réels)
