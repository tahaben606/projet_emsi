...
### _Bridging the Gap in Academic Success through AI and Analytics_
...
```text
projet_emsi/
├── src/                    # Source code (Next.js, Components, Services)
│   ├── app/               # Pages & API routes
│   ├── components/        # React components
│   ├── services/          # Business logic (AI, RAG, Analytics)
│   └── lib/              # Utilities & helpers
├── prisma/               # Database schema & migrations
├── scripts/              # Development utilities (CLI only, not for production)
...
For development utilities, database setup, and testing scripts, see [DEVELOPMENT.md](DEVELOPMENT.md).
...
_Empowering education through intelligent data and AI._ 🚀
